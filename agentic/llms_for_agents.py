...
class LLMsForAgents:
    ...
    retriever_llm: BaseChatModel = field(default_factory=lambda: ChatGroq(model="llama-3.3-70b-versatile", temperature=0))
    ...
    critic_llm: BaseChatModel = field(default_factory=lambda: ChatGroq(model="llama-3.3-70b-versatile", temperature=0))
